...
\leftheader{%
  {\LARGE\bfseries\sffamily Ping-Lin (Billy) Kuo}

  \makefield{\faBirthdayCake} {\texttt{Birthday: 05/07/1998, Taichung City, Taiwan}}

  \makefield{\faHome} {\texttt{Address: No.92-3, Chaogui 1st St., Xitun Dist., Taichung City 407, Taiwan}}

  \makefield{\faPhone} {\texttt{Phone number: + 866 939-107-529}}

  \makefield{\faEnvelope[regular]}{\href{mailto:example@gmail.com}{\texttt{billyg123@gmail.com}}}
  \makefield{\faLinkedin}{\href{https://www.linkedin.com/in/ping-lin-billy-kuo/}{\texttt{ping-lin-billy-kuo}}}
  \makefield{\faGithub}{\href{https://github.com/billy0705}{\texttt{billy0705}}}
...
\rightheader{~}
\begin{fullonly}
\photo[r]{Profile_Photo_PING-LIN_KUO.png}
\photoscale{0.13}
\end{fullonly}
